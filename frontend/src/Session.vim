...
nnoremap - ddp
nnoremap ; :
nnoremap <space>d :YcmShowDetailedDiagnostic
nmap <space>ca <Plug>NERDCommenterAltDelims
xmap <space>cu <Plug>NERDCommenterUncomment
nmap <space>cu <Plug>NERDCommenterUncomment
xmap <space>cb <Plug>NERDCommenterAlignBoth
nmap <space>cb <Plug>NERDCommenterAlignBoth
xmap <space>cl <Plug>NERDCommenterAlignLeft
nmap <space>cl <Plug>NERDCommenterAlignLeft
...
xmap <space>ci <Plug>NERDCommenterInvert
nmap <space>ci <Plug>NERDCommenterInvert
...
xmap <space>cc <Plug>NERDCommenterComment
nmap <space>cc <Plug>NERDCommenterComment
nnoremap <space>sv :source $MYVIMRC
nnoremap <space>ev :vsplit $MYVIMRC
nnoremap X viwx
nnoremap _ dd2kp
...
silent only
silent tabonly
cd ~/Documents/playground/chatapp/frontend/src
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 27 - ((19 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 70 - ((27 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
normal! 034|
tabnext
edit components/ChatWindow/MessageStrip.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 49 - ((20 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
normal! 036|
tabnext
edit components/ChatWindow/SendStrip.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 040|
tabnext
edit redux/actionCreators/index.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
if bufexists("redux/reducers/chatReducer.js") | buffer redux/reducers/chatReducer.js | else | edit redux/reducers/chatReducer.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
set stal=1
badd +3 App.js
badd +0 pages/ChatWindow.js
badd +0 services/socket.js
badd +1 redux/actions/index.js
badd +10 redux/actionCreators/index.js
badd +10 redux/reducers/chatReducer.js
badd +2 redux/reducers/index.js
badd +0 components/ChatWindow/MessageStrip.js
badd +0 components/ChatWindow/SendStrip.js
badd +0 ../package.json
